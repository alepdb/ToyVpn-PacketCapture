...
public class ToyVpnClient extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        packages.setText(String.join(", ", Objects.requireNonNull(prefs.getStringSet(
...
//            Decomment to print all the packages installed on device
//            for (Object pack:getPackageManager().getInstalledPackages(0)) {
